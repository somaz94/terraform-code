...
variable "db-subnet-cidr" {
  default     = ["10.0.12.0/24", "10.0.22.0/24", "10.0.23.0/24"]
  type        = list
...
variable "ec2-key-public-key" {
  default     = "ssh-rsa  genius5711@gmail.com"
  type        = string
